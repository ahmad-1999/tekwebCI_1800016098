...
<head>
    ...
    <!-- site icons -->
    <link rel="icon" href="<?= base_url('tamplate2'); ?>/images/fevicon/fevicon.png" type="<?= base_url('tamplate2'); ?>/image/png" />
    <!-- bootstrap css -->
    <link rel="stylesheet" href="<?= base_url('tamplate2'); ?>/css/bootstrap.min.css" />
    <!-- site css -->
    <link rel="stylesheet" href="<?= base_url('tamplate2'); ?>/css/style.css" />
    <!-- responsive css -->
    <link rel="stylesheet" href="<?= base_url('tamplate2'); ?>/css/responsive.css" />
    <!-- colors css -->
    <link rel="stylesheet" href="<?= base_url('tamplate2'); ?>/css/colors.css" />
    <!-- wow animation css -->
    <link rel="stylesheet" href="<?= base_url('tamplate2'); ?>/css/animate.css" />
    <!--[if lt IE 9]>
...
<body id="default_theme" class="home_page1">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9 col-lg-10">
                    <div class="logo"><a href="index.html"><img src="<?= base_url('tamplate2'); ?>/images/logo.png" alt="#" /></a></div>
                ...
                <div class="col-md-6">
                    <div class="full">
                        <div class="slide_cont">
                            ...
                            <div class="full slide_bt"> <a class="white_bt bt_main" href="<?= base_url('login/logout'); ?>" role="button">Loguot</a> </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="full">
                        <div class="slide_pc_img wow fadeInRight" data-wow-delay="1s" data-wow-duration="2s"> <img src="<?= base_url('tamplate2'); ?>/images/pc-banner.png" alt="#" /> </div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row margin_bottom_30">
                ...
                <div class="col-md-6 wow fadeInRight" data-wow-delay="0.5" data-wow-duration="1s">
                    <div class="full">
                        <div class="center"><img src="<?= base_url('tamplate2'); ?>/images/ser1.png" alt="#" /></div>
                    </div>
                </div>
                <!-- end featured image -->
            </div>
            <div class="row margin_bottom_30">
                ...
                <div class="col-md-6 wow fadeInLeft" data-wow-delay="0.5" data-wow-duration="1s">
                    <div class="full">
                        <div class="center"><img src="<?= base_url('tamplate2'); ?>/images/ser2.png" alt="#" /></div>
                    </div>
                </div>
                <!-- end featured image -->
                <!-- featured cont -->
            ...
            <div class="row margin_bottom_30">
                ...
                <div class="col-md-6 wow fadeInRight" data-wow-delay="0.5" data-wow-duration="1s">
                    <div class="full">
                        <div class="center"><img src="<?= base_url('tamplate2'); ?>/images/ser3.png" alt="#" /></div>
                    </div>
                </div>
                <!-- end featured image -->
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="information_blogs">
                        <div class="imf_icon"><img src="<?= base_url('tamplate2'); ?>/images/icon1.png" alt="#" /></div>
                        <div class="imf_head">
                ...
                <div class="col-md-4">
                    <div class="information_blogs">
                        <div class="imf_icon"><img src="<?= base_url('tamplate2'); ?>/images/icon2.png" alt="#" /></div>
                        <div class="imf_head">
                ...
                <div class="col-md-4">
                    <div class="information_blogs">
                        <div class="imf_icon"><img src="<?= base_url('tamplate2'); ?>/images/icon3.png" alt="#" /></div>
                        <div class="imf_head">
        ...
        <div class="container">
            ...
            <div class="row app-features">
                ...
                <div class="col-md-4 wow fadeInRight" data-wow-delay="0.5" data-wow-duration="1s">
                    <div class="full">
                        <div class="center">
                            <img src="<?= base_url('tamplate2'); ?>/images/application_screen.png" alt="#" />
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-4">
                                <div class="table_price text_align_center">
                                    ...
                                    <div class="table_price_bottm"> <a class="bt_main" href="<?= base_url('tamplate2'); ?>/index.html">Buy now</a> </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 margin_bottom_30">
                        <div class="full">
                            ...
                            <div class="blog_post_footer">
                                <div class="blog_post_img"> <img width="80" height="80" src="<?= base_url('tamplate2'); ?>/images/scr1.png" alt="#"> </div>
                            ...
                            <div class="blog_post_footer">
                                <div class="blog_post_img"> <img width="80" height="80" src="<?= base_url('tamplate2'); ?>/images/scr2.png" alt="#"> </div>
                                <div class="blog_post_cont">
                                    <p class="date">July 22, 2015</p>
                                    <p class="post_head">Round and round like a carousel</p>
                                </div>
                            ...
                            <div class="blog_post_footer">
                                <div class="blog_post_img"> <img width="80" height="80" src="<?= base_url('tamplate2'); ?>/images/scr3.png" alt="#"> </div>
                                <div class="blog_post_cont">
                                    <p class="date">July 22, 2015</p>
                                    <p class="post_head">Round and round like a carousel</p>
                                </div>
    ...
    <script src="<?= base_url('tamplate2'); ?>/js/jquery.min.js"></script>
    <script src="<?= base_url('tamplate2'); ?>/js/popper.min.js"></script>
    <script src="<?= base_url('tamplate2'); ?>/js/bootstrap.min.js"></script>
    <!-- wow animation -->
    <script src="<?= base_url('tamplate2'); ?>/js/wow.js"></script>
    <!-- custom js -->
    <script src="<?= base_url('tamplate2'); ?>/js/custom.js"></script>
    <!-- google map js -->
